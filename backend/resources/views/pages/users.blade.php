                ...
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        ...
                        <div class="d-flex  align-items-center justify-content-between">
                            <input type="text" class="w-50 form-control col-md-4  float-left" name="search" id="search" placeholder="Search...">
                            <div class="">
                                {{ $data->links() }}
                            </div>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="text-xs text-secondary mb-0">PlanIt</p>
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <a href="{{ route('profile', ['user_id' => $user->id]) }}" class="text-secondary font-weight-bold text-xs"
